...
def plot_learning_curves(env_num,base_dir, env_name, arr_algorithm_name, num_actors, total_iter,
                         max_timesteps=1e6, with_std=False, with_eval=False, arr_name_plot=None, with_title=True, with_q_power=True, with_all_actors=False,
    ...
    if not os.path.isdir('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures'):
        os.mkdir('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures')
    if not os.path.isdir('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures/'+filename):
        os.mkdir('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures/'+filename)
    # plt.show()
...
ENV_INFO = [
    ...
    # {'env_name': 'MECS-v1_c300.0', 'max_timesteps': int(3e7)},  # 2
    # {'env_name': 'MECS-v1_c500.0', 'max_timesteps': int(3e7)},  # 2
    # {'env_name': 'MECS-v1_c800.0', 'max_timesteps': int(3e7)},  # 2
    {'env_name': 'MECS-v1_c1000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c2000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c3000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c4000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c5000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c6000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c8000.0', 'max_timesteps': int(3e7)},
    {'env_name': 'MECS-v1_c10000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c20000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c30000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c40000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c50000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c60000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c70000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c80000.0', 'max_timesteps': int(3e7)},
    # {'env_name': 'MECS-v1_c90000.0', 'max_timesteps': int(3e7)},
...
ALGORITHM_INFO = [
    {'algorithm_name': 'ppo2', 'num_actors': 1, 'name_plot': 'PPO'},         #0
...
def main():
    ...
    parser.add_argument('--base_dir', help = 'Base directories', default='/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/')
    ...
    parser.add_argument('--with-q-power', type=bool, default=True)
    parser.add_argument('--with_q_power', type=bool, default=True)
    ...
    for i in range(6):
        ...
        plot_learning_curves(i,args.base_dir, args.env_name, args.algorithm_name, args.num_actors, args.total_iter,
                             max_timesteps=args.max_timesteps, with_std=args.with_std, with_eval=args.with_eval, with_title=args.with_title, with_q_power=args.with_q_power, arr_name_plot=args.name_plot,
                             fig_size=args.fig_size, save_filename=args.algorithm_ind[-1], save_fig=args.save_fig, save_format=args.save_format)
    if args.with_q_power:
        ...
        for graph in graph_list:
            ...
            dir_name = "./baselines/rl_agents/results/" + dir_names[graph]
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures/_mecs/', "q_power.pdf"))
    else:
        plt.savefig(os.path.join('/home/wisrl/Downloads/power_scaled_cross_term/log_ppo/figures/_mecs/', "reward.pdf"))
    plt.show()
