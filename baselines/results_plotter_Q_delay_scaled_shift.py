...
def plot_learning_curves(env_num,base_dir, env_name, arr_algorithm_name, num_actors, total_iter,
    ...
    if not os.path.isdir('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures'):
        os.mkdir('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures')
    if not os.path.isdir('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures/'+filename):
        os.mkdir('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures/'+filename)
    # plt.show()
...
def main():
    ...
    parser.add_argument('--base_dir', help = 'Base directories', default='/home/wisrl/Downloads/power_scaled_shift/log_ppo/')
    ...
    if args.with_q_power:
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures/_mecs/', "q_power.pdf"))
    else:
        plt.savefig(os.path.join('/home/wisrl/Downloads/power_scaled_shift/log_ppo/figures/_mecs/', "reward.pdf"))
    plt.show()
